...
Exercise.create :muscle => "Abdominal", :name => "Crunch", :reps => "3x30", :duration => 10, :gym => 0, :core => false, :description => "Lie supine on bench with head hanging off and knees and hips bent. Flex waist to raise upper torso from bench. Keep low back on bench and raise torso up as high as possible. Return until back of shoulders contact padded incline board. Repeat."

Exercise.create :muscle => "Abdominal", :name => "Sit up", :reps => "3x25", :duration => 15, :gym => 0, :core => false, :description => "Hook feet under foot brace and lie supine on incline board with hips bent. Raise torso from bench by bending waist and hips. Return until back of shoulders contact padded incline board. Repeat."
...
Exercise.create :muscle => "Lower Back", :name => "Back extension", :reps => "3x20", :duration => 10, :gym => 0, :core => true, :description => "Position thighs prone on large pad and lower legs under padded brace. Lower body by bending waist until fully flexed. Raise, or extend waist until torso is parallel to legs. Repeat."
...
Exercise.create :muscle => "Abdominal", :name => "Decline sit up", :reps => "3x25", :duration => 15, :gym => 1, :core => false, :description => "Sit on apparatus with lower leg secured under padded bar. Lower body back until hips are almost extended. Raise body by flexing hips until torso is upright. Repeat."
...
Exercise.create :muscle => "Abdominal", :name => "JackKnife", :reps => "3x25", :duration => 15, :gym => 0, :core => false, :description => "Sit on floor or mat. Lie supine with hands to sides. Simultaneously raise knees and torso until hips and knees are flexed. Return to starting position with waist, hips and knees extended. Repeat."
  end
